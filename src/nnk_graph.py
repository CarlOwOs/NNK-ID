...
def get_nnk_weighted_graph(features, topk):
    ...
    distances = np.copy(similarities)
    ...
    for i, x in enumerate(features):
        ...
        #sigma = (similarities[i, 14]/3)**2    
        #sigma = np.quantile(similarities[i, :], 1)**2
    ...
    return similarities, indices, distances, sigma
